...
rm quickbook-config.tar.gz
kubectl --kubeconfig=/home/appuser/.kube/bidclips_${DeployEnv}_config -n app-stack delete configmap quickbook-config
kubectl --kubeconfig=/home/appuser/.kube/bidclips_${DeployEnv}_config -n app-stack create configmap quickbook-config --from-file=quickbook-config/
sleep 5;
rm -rf quickbook-config/
kubectl --kubeconfig=/home/appuser/.kube/bidclips_${DeployEnv}_config apply -f quickbook.yaml
rm quickbook*
sleep 5;
kubectl --kubeconfig=/home/appuser/.kube/bidclips_${DeployEnv}_config -n app-stack get deploy | grep quickbook
exit
EOA
      """
    }
