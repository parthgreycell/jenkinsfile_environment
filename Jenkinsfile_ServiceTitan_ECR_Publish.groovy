  ...
  try{
    properties([
      ...
      parameters([
        ...
        [$class: 'ListSubversionTagsParameterDefinition', credentialsId: 'munjal-gc-un-pw', defaultValue: '', maxTags: '', name: 'TagName', reverseByDate: true, reverseByName: false, tagsDir: 'https://github.com/BidClips/BidClips-ServiceTitan-API.git', tagsFilter: '']
      ])
    ])
    def PUBLISHTAG = ""
    def repoRegion = ""
    ...
    stage('Building Docker Image'){
      dir('BidClips-ServiceTitan-API') {
        ...
        docker images | grep bidclipsservicetitanapi
        """
      }
    }
...
docker tag bidclipsservicetitanapi:latest 566570633830.dkr.ecr.${repoRegion}.amazonaws.com/bidclips-servicetitan-api:${PUBLISHTAG}
docker push 566570633830.dkr.ecr.${repoRegion}.amazonaws.com/bidclips-servicetitan-api:${PUBLISHTAG}
        """
...
// docker tag bidclipsservicetitanapi:latest 875588116685.dkr.ecr.us-east-1.amazonaws.com/bidclips-servicetitan-api:${PUBLISHTAG}
// docker push 875588116685.dkr.ecr.us-east-1.amazonaws.com/bidclips-servicetitan-api:${PUBLISHTAG}
// docker image rmi -f 875588116685.dkr.ecr.us-east-1.amazonaws.com/bidclips-servicetitan-api:${PUBLISHTAG}
//         """
//       }
    }
    stage('Cleanup'){
      sh """
      docker image rmi -f bidclipsservicetitanapi:latest
      docker image rmi -f 566570633830.dkr.ecr.${repoRegion}.amazonaws.com/bidclips-servicetitan-api:${PUBLISHTAG}
      """
      dir('BidClips-ServiceTitan-API') {
        deleteDir()
      }
