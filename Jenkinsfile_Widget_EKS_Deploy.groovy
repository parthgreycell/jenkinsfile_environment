node("built-in"){
  try{
    ...
    stage('Preparation'){
      ...
      if(DeployEnv == "prod"){
        dockerImageWithTag="875588116685.dkr.ecr.us-east-1.amazonaws.com/bidclips-web-widget:${DEPLOYTAG}".replace(':','\\:')
      }
      else{
        dockerImageWithTag="566570633830.dkr.ecr.${repoRegion}.amazonaws.com/bidclips-web-widget:${DEPLOYTAG}".replace(':','\\:')
      }
...
scp widget.yaml ec2-user@3.0.102.120:/home/ec2-user/widget.yaml
        """
      }
    }
